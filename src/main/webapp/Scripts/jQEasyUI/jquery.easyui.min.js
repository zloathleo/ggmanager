...
//                                return (_66d == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr.datagrid-row:has(div.datagrid-cell-check input:checked)");
                                  return (_66d == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr.datagrid-row>td>div.datagrid-cell-check>input:checked").parent().parent().parent();
                            } else {
                                if (type == "last") {
...
(function ($) {
    ...
    var _695 = $.extend({}, $.fn.datagrid.defaults.view, { render: function (_69f, _6a0, _6a1) {
        ...
        for (var i = 0; i < _6a6.length; i++) {
            ...
            if (!_6a1) {
                _6a4.push("<span style=\"color:#232399;font-weight:bold;\">");
                ...
                if (col.checkbox) {
                    ...
                    if (_761 == opts.treeField) {
                        ...
                        if (row.state == "closed") {
                            ...
                            cc.push("<span class=\"tree-icon " + (row.iconCls ? row.iconCls : "") + "\"></span>");
                        } else {
                            if (row.children && row.children.length) {
