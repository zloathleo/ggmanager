...
<head>
    ...
    <script type="text/javascript">
        ...
        function Add() {
            ...
            easyuiDialog("实时视频 - 新增", url, 600, 280, paramString);
        }
        ...
        function Edit() {
            ...
            if (_row) {
                ...
                var url = "open_operate?" + paramString;
                easyuiDialog("实时视频 - 修改", url, 600, 280, paramString);
            }
        }
        ...
        function Delete() {
            ...
            if (_row) {
                ...
                var url = "open_operate?" + paramString;
                easyuiDialog("实时视频 - 删除", url, 350, 280);
            }
        }
    </script>
</head>
...
<div data-options="region:'center',border:false,iconCls:'icon-list'">
    ...
    <table id="grid" border="false" fit="true" class="easyui-datagrid" url="load_zb"
